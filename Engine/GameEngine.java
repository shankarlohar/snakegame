...
public class GameEngine extends JPanel implements ActionListener {
    ...
    private void loadImages() {
        ...
        ImageIcon iih = new ImageIcon("GameData/Snake/SnakeHead.png");
        head = iih.getImage();

        ImageIcon iid = new ImageIcon("GameData/Snake/SnakeBody.png");
        ball = iid.getImage();
    ...
    private void initGame() throws UnsupportedAudioFileException, IOException, LineUnavailableException {
        File audiofile = new File("GameData/Music/GameMusic.wav");
    ...
    private void gameOver(Graphics g) {
        ...
        g.drawString(score, (B_WIDTH - (B_WIDTH / 2)), (B_HEIGHT - (B_HEIGHT / 10)));
    }
